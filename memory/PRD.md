...
- Parent-facing insights: endpoint allows student-self view (summary+score+recommendations); a student-portal insights card is NOT yet placed (StudentInsights component is ready to drop into the student dashboard) — small follow-up.
