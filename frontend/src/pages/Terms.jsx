...
const SECTIONS = [
  ...
  { h: "5. Data Protection & Retention", p: "We apply role-based access control, per-institute data isolation, and encrypted cloud storage (in transit and at rest). Personal data is deleted or anonymised within 30 days of account closure or a valid erasure request, except where a record must be retained to meet a legal obligation. A designated Grievance Officer handles data-rights requests under the DPDP Act, 2023 (see our Privacy Policy)." },
